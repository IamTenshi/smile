<?php 
    ...
    if (!preg_match("/^(?=.{3,18}$)[a-záéíóúñüA-ZÁÉÍÓÚÑÜ](\s?[a-záéíóúñüA-ZÁÉÍÓÚÑÜ])*$/", $name)) {
        ...
        echo "<script>alert('The name is too long or contains invalid characters');</script>";
    }
    ...
    if (!preg_match("/^(?=.{3,36}$)[a-záéíóúñüA-ZÁÉÍÓÚÑÜ](\s?[a-záéíóúñüA-ZÁÉÍÓÚÑÜ])*$/", $last_name)) {
        ...
        echo "<script>alert('The last name is too long or contains invalid characters');</script>";
    }
